class AlbumsController < ApplicationController
  def create
    ...
    album.artist_url = "https://127.0.0.1:3000/artists/#{params[:artist_id]}"
    album.tracks_url = "https://127.0.0.1:3000/artists/#{album.id}/tracks"
    album.self_url = "https://127.0.0.1:3000/albums/#{album.id}"
