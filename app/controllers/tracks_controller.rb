class TracksController < ApplicationController
  def create
    ...
    track.album_url = "https://127.0.0.1:3000/albums/#{params[:album_id]}"
    track.artist_url = "https://127.0.0.1:3000/artists/#{search_album.artist_id}"
    track.self_url = "https://127.0.0.1:3000/tracks/#{track.id}"
